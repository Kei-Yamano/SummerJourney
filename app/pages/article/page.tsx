          ...
          {featuredArticles.map((article) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div
                  className={`absolute top-4 left-4 px-3 py-1 rounded-full text-sm font-medium ${getPlatformColor(article.platform)}`}
                >
                  {article.platform}
                </div>
                <div
                  className={`absolute bottom-4 left-4 ${getCategoryColor(article.category)} text-white px-3 py-1 rounded-full text-sm font-medium`}
                >
                  {article.category}
                </div>
              </div>
          ...
          {techArticles.map((article) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div
                  className={`absolute top-3 left-3 px-2 py-1 rounded text-xs font-medium ${getPlatformColor(article.platform)}`}
                >
                  {article.platform}
                </div>
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 mb-4 text-sm leading-relaxed line-clamp-3">{article.excerpt}</p>
