...
export default function About() {
  const profileInfo = {
    ...
    birthPlace: "大阪府堺市",
    introduction:
      "コマンドを覚えることに情熱を持つエンジニア志望の大学生です。Next.jsやReactを使ったウェブアプリケーション開発に興味があり、このポートフォリオサイトを通じて自分の経歴やスキル、制作物を紹介しています。技術への好奇心と創造性を活かし、ユーザーに価値を提供するプロダクト開発に取り組んでいきたいと考えています。",
    ...
    highlights: [
      {
        ...
        title: "問題解決への情熱",
        description:
          "格闘ゲームで培った戦略的思考と分析力を活かし、複雑な技術的課題に対して論理的かつ創造的なアプローチで解決策を見つけることができます。",
      },
      {
        icon: <Lightbulb className="h-6 w-6 text-yellow-600" />,
        title: "継続的な学習意欲",
        description:
          "新しい技術やフレームワークに対する強い好奇心を持ち、常に最新のトレンドをキャッチアップしながら自己成長を続けています。",
      },
      {
        icon: <Zap className="h-6 w-6 text-purple-600" />,
        title: "実践的なスキル習得",
        description:
          "理論だけでなく、実際にプロダクトを作り上げることで技術を身につけ、ユーザーの視点を大切にした開発を心がけています。",
      },
    ],
    strengths: [
      "格闘ゲームで培った集中力と戦略的思考",
  ...
  const organizations = [
    {
      ...
      website: "#",
      activities: ["イベント企画・運営", "学生支援プログラム", "ネットワーキング"],
    },
  ]
  ...
  const hobbies = [
    {
      name: "格闘ゲーム",
      description: "コマンド入力の正確性と戦略的思考を磨く。主にストリートファイターシリーズをプレイ。",
      icon: "🥊",
      color: "from-red-100 to-orange-100",
    },
    {
      name: "漫画",
      description: "様々なジャンルの漫画を読み、ストーリーテリングやキャラクター設計を学ぶ。",
      icon: "📚",
