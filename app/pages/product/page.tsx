...
export default function Product() {
  const projects = [
    ...
    } /*
    {
      id: 5,
      title: "Blog Platform",
      description: "マークダウンエディター付きのブログプラットフォーム。記事管理、コメント機能、検索機能を実装。",
    ...
    },
    {
      id: 6,
      title: "Mobile Game",
      description: "React Native で開発したモバイルゲーム。物理エンジン、スコアシステム、ソーシャル機能を含む。",
      image: "/placeholder.svg?height=300&width=400",
  ...
  return (
    <div className="container px-4 py-12 md:px-6 md:py-16 max-w-7xl mx-auto">
      ...
      <section className="mb-20">
        <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">注目のプロジェクト</h2>
      ...
      {/* Other Projects */}
      <section>
        <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">その他のプロジェクト</h2>
